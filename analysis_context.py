...
4. "표 간 관계와 비교 가능성" data-table: 연결 대상 / 공통 기준 / 겹치는 값 / 비교 가능성 / 주의점
5. "리스크와 기회" data-table: 구분 / 항목 / 실제 근거 / 예상 영향 / 관찰 지표
6. "실행 계획" data-table: 우선순위 / 실행 과제 / 실행 근거 / 담당 역할·시기 / 확인 지표·검증 방법
7. "한계와 다음 질문" data-table: 구분 / 내용 / 추가로 필요한 데이터 또는 후속 자연어 SQL 질문
